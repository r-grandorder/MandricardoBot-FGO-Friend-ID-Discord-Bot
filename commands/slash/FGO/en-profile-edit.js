...
module.exports = {
    ...
    description: 'Save or edit your FGO EN profile (IGN, Friend ID, support images, privacy).',
    type: 1,
    options,
    permissions: {
    ...
    run: async (client, interaction, config, db) => {
        try {
            ...
            await util.fgoProfiles(interaction.user, profile, interaction, 'en', true, PAGE_COUNT);
