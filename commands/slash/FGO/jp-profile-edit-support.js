...
module.exports = {
    name: 'jp-profile-edit-support',
    description: 'Set the support-list image for one page of your FGO JP profile.',
    type: 1,
    options: [
    ...
    run: async (client, interaction, config, db) => {
        try {
            ...
            console.log(`[JP-PROFILE-EDIT-SUPPORT] page ${page} by ${interaction.user.id}`);
            ...
            console.error('[JP-PROFILE-EDIT-SUPPORT]', err);
